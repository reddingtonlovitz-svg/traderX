...
2. **Extract CSS** for every element in the section. Use the extraction script — don't hand-measure individual properties. Run it once per component container and capture the full output:

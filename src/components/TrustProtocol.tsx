...
import { ShieldCheck, Target, Building, Rocket, Scale, CheckCircle } from "lucide-react";
...
export const TrustProtocol = () => {
  ...
  return (
    <section id="безопасность" ref={container} className="bg-primary text-paper overflow-hidden">
      {/* Why it's Safe Section */}
      <div className="py-32 px-6 sm:px-12 md:px-24 max-w-7xl mx-auto">
        <div className="max-w-3xl mb-24">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-px bg-accent" />
            <span className="text-[10px] font-mono font-bold uppercase tracking-[0.3em] text-accent">Безопасность</span>
          </div>
          <h2 className="text-4xl sm:text-6xl font-sans font-black tracking-tighter uppercase leading-[0.9] mb-8">
            Самый важный вопрос здесь — <span className="text-accent underline decoration-accent/10">доверие</span>. И это нормально
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {trustCards.map((card, i) => (
            <div 
              key={i} 
              className="trust-card p-12 bg-paper/5 border border-paper/10 rounded-huge hover:bg-paper/10 transition-all duration-700 group"
            >
              <div className="flex flex-col gap-10">
                <div className="w-12 h-12 rounded-2xl bg-paper/10 flex items-center justify-center group-hover:bg-accent transition-all duration-500">
                  <card.icon className="w-5 h-5 text-accent group-hover:text-primary transition-colors" />
                </div>
                <div className="flex flex-col gap-4">
                  <h4 className="text-xl font-sans font-bold leading-tight uppercase group-hover:text-accent transition-colors">
                    {card.title}
                  </h4>
                  <p className="text-sm text-paper/40 leading-relaxed font-medium">
                    {card.desc}
                  </p>
                </div>
              </div>
          ...
          <div className="trust-card p-12 bg-accent rounded-huge flex flex-col justify-center items-center text-center group">
             ...
             <p className="text-primary/60 text-xs font-mono font-bold uppercase tracking-widest leading-relaxed">
      ...
      <div className="founders-section py-32 px-6 sm:px-12 md:px-24 bg-white text-primary rounded-t-[4rem]">
        <div className="max-w-7xl mx-auto flex flex-col gap-24">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="founders-box flex flex-col gap-8">
              <div className="flex flex-col gap-4">
                <span className="font-mono text-[10px] text-accent uppercase tracking-widest font-bold">Основатели и база</span>
              ...
              <div className="grid sm:grid-cols-2 gap-8 py-8 border-t border-primary/5">
                <div className="flex flex-col gap-3">
                  <h5 className="font-sans font-bold text-sm uppercase tracking-wider">Опыт основателей</h5>
                  <p className="text-xs text-primary/50 leading-relaxed">Люди, которые давно работают внутри рынка, знают его ограничения и требования к реальным продажам.</p>
                </div>
                <div className="flex flex-col gap-3">
                  <h5 className="font-sans font-bold text-sm uppercase tracking-wider">Опора на базу</h5>
                  <p className="text-xs text-primary/50 leading-relaxed">В основе проекта — опыт действующей компании, понимание логистики, поставщиков и деловой среды.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative aspect-square lg:aspect-video rounded-huge overflow-hidden border border-primary/5 shadow-2xl group">
               ...
               <div className="absolute bottom-10 left-10 p-8 bg-primary/90 backdrop-blur-xl rounded-large border border-paper/10 max-w-xs transition-transform group-hover:translate-x-2">
                  <p className="text-paper text-sm font-sans font-bold uppercase tracking-widest leading-none mb-4">Взрослая коммерческая модель</p>
                  <p className="text-paper/40 text-[10px] leading-relaxed">Мы строим среду для профессионалов, которые уже умеют работать в рынке.</p>
               </div>
            </div>
          </div>
        </div>
